...
<html>
    ...
    <body>
        <div id="content"   class="panel panel-default">
            ...
            <div class="panel-heading">Panel vista de eventos programados  <span class="alert alert-info">Evento:  Desactive</span></div>
            <p>
                <?php
                $cadena = date('j-n-Y');
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($datos as $data_row) {
                        ...
                        $cadena2 = $data_row->termina;
                        $cadena2 = ereg_replace("[^A-Za-z0-9]", "", $cadena2);
                        $cadena2;
                        if ($cadena2 >= $cadena) {
                            if ($cadena2 == $cadena) {
                                echo "<td>Desactivando...</td>";
                                $param = array(
                                    'id' => $data_row->id
                                );
